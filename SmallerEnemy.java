...
//    }
    ...
    public SmallerEnemy(double posX, double posY, long startTime, long appearTime) {
        this.posX = posX;
        this.posY = posY;
    ...
    public List<Image> getImage() {
        ...
        images.add(new Image("image/SmallerEnemy.png"));
